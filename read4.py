...
W = tf.Variable(tf.random_normal([28*28, 370], mean=0.0, stddev=1.0, dtype=tf.float32, seed=None, name=None))
b = tf.Variable(tf.random_normal([370], mean=0.0, stddev=1.0, dtype=tf.float32, seed=None, name=None))
h = tf.nn.sigmoid(tf.matmul(x,W) + b)

W1 = tf.Variable(tf.random_normal([370, 200], mean=0.0, stddev=1.0, dtype=tf.float32, seed=None, name=None))
b1 = tf.Variable(tf.random_normal([200], mean=0.0, stddev=1.0, dtype=tf.float32, seed=None, name=None))
...
np.savetxt('testW1.out', sess.run(W), delimiter=',')
np.savetxt('testb1.out', sess.run(b), delimiter=',')
